...
def save_result(results_metrics,name):

  f = open('results/'+name+'.txt', "a+")
  f.write((str(results_metrics[0])[0:6])+',')
  f.write( (str(results_metrics[1])[0:6])+',')
  f.write((str(results_metrics[2])[0:6])+',')
  f.write((str(results_metrics[3])[0:6])+',')
  f.write((str(results_metrics[4])[0:6])+',')
  f.write((str(results_metrics[5])[0:6])+',')
  f.write((str(results_metrics[6])[0:6])+'\n')
